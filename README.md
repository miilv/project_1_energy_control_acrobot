...
Controllers for an underactuated two-link acrobot, built incrementally from
energy-shaping toward model-predictive control. Each subfolder is a
self-contained piece with its own code, plots, animation, slides, and notes.
...
Mariya Lezina · Safina Gulyamova · Hajira Amjad · Ilya Mikhalchuk · Mikhail Sannikov
